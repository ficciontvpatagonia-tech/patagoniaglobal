#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genera notas/{id}.html (ES) + variantes -en/-pt/-zh del informe Malvinas
calamar usando las traducciones ya escritas en propios.json (sin API).
Patrón correcto de relacionadas: ES solo con pool ES; cada variante con
pool de su idioma (modelo: fix_relacionadas_ara.py)."""
import os, sys, json
...
BID = "20260714-propio-malvinas-calamar"
LANGS = ["en", "pt", "zh"]
