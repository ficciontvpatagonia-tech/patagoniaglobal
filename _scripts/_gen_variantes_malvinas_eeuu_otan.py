...
malvinas-eeuu-otan usando las traducciones ya escritas en propios.json
(sin API). Patrón: _gen_variantes_santacruz_construccion.py."""
import os, sys, json
...
BID = "20260830-propio-malvinas-eeuu-otan"
LANGS = ["en", "pt", "zh"]
