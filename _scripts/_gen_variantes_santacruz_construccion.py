...
santa-cruz-construccion usando las traducciones ya escritas en propios.json
(sin API). Patrón: _gen_variantes_kelper.py."""
import os, sys, json
...
BID = "20260824-propio-santa-cruz-construccion"
LANGS = ["en", "pt", "zh"]
