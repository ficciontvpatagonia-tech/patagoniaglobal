...
Argentina-Inglaterra usando las traducciones ya escritas en propios.json
(sin API). Patrón: _gen_variantes_calamar.py."""
import os, sys, json
...
BID = "20260714-propio-argentina-inglaterra"
LANGS = ["en", "pt", "zh"]
